"""Reference agent built on MemoryMesh.

This example demonstrates how a domain-specific agent uses MemoryMesh as
...
def run_ticket_investigation(base_url: str, task: str) -> dict:
    """Run a support-ticket investigation through the MemoryMesh SDK."""
    tm = MemoryMeshClient(base_url=base_url)
