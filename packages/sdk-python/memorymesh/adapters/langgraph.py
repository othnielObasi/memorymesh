"""LangGraph adapter for MemoryMesh.
...
class MemoryMeshLangGraphAdapter:
    """Records LangGraph-like node transitions into MemoryMesh."""

    def __init__(self, client: MemoryMeshClient, task_id: str, graph_name: str = "langgraph"):
        self.client = client
...
MemoryMeshCheckpointer = MemoryMeshLangGraphAdapter
