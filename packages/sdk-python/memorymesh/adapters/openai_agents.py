"""OpenAI Agents SDK style middleware for MemoryMesh.
...
class MemoryMeshOpenAIAgentsMiddleware:
    """MemoryMesh middleware for OpenAI Agents SDK style applications."""

    def __init__(self, client: MemoryMeshClient, task_id: str, agent_id: str):
        self.client = client
