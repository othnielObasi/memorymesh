"""Framework-neutral tool wrappers for MemoryMesh.
...
class ToolWrapperConfig:
    ...
    Args:
        tool_name: Stable tool name to show in MemoryMesh.
...
def trace_tool(client: MemoryMeshClient, task_id: str, config: ToolWrapperConfig) -> Callable[[F], F]:
    """Wrap a function and record its execution as a MemoryMesh tool trace.
