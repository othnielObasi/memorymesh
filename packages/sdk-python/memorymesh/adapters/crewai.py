...
class MemoryMeshCrewAIAdapter:
    """Records CrewAI task execution and tool calls into MemoryMesh."""

    def __init__(self, client: MemoryMeshClient, task_id: str, crew_name: str = "crew"):
        self.client = client
