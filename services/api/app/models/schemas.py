...
class SystemStatus(BaseModel):
    ...
    cognee_backend: str = 'offline_mirror'
    cognee_provider: str = 'Cognee-compatible offline mirror'
...
class PartnerStatus(BaseModel):
    ...
    truefoundry_models: Dict[str, str] = Field(default_factory=dict)
    truefoundry_mcp_ready: bool = False
...
class ModelGatewayConfigRequest(BaseModel):
    name: str = Field(..., min_length=2)
    provider: str = Field(default="truefoundry")
