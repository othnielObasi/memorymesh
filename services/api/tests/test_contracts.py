...
def test_sdk_adapter_files_exist():
    ...
    assert (root / 'packages/sdk-python/memorymesh/adapters/langgraph.py').exists()
    assert (root / 'packages/sdk-python/memorymesh/adapters/crewai.py').exists()
    assert (root / 'packages/sdk-python/memorymesh/adapters/openai_agents.py').exists()
    assert (root / 'packages/sdk-python/memorymesh/adapters/tool_wrapper.py').exists()
